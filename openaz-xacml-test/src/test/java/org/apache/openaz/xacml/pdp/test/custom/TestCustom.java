...
/**
 * TestCustom is an application that tests the extensibility and configurability of the Apache OpenAZ XACML
 * API. It creates a custom datatype definition factory that adds in custom data types for RSA PublicKey and
